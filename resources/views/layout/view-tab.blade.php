...
<div class="grid grid-cols-12 gap-6 mt-4">
    ...
    <div class="header-line col-span-12 lg:col-span-6 grid gap-3">
    ...
    <div class="page-content col-span-12 lg:col-span-6 grid gap-3 large-screen">
        <div class="intro-y block sm:flex items-center h-10">
            <div class="ml-auto mt-3 sm:mt-0 relative text-gray-700 dark:text-gray-300">
                <div class="flex items-center border-b border-gray-200 dark:border-dark-5" id="btn-holder">
                    <span class="printdiv" id="new_button"></span>
                    <div id="checkin-button-holder"></div>&nbsp; &nbsp; 
                    <div class="col-span-12 sm:col-span-12" id="printdiv"></div>
                ...
                <div><a class="button w-20 bg-theme-6 text-white " id="cancel" href="{{ url()->previous() }}">Cancel</a></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="grid grid-cols-12 gap-1 mt-1">
    <!-- form area -->
    <div class="col-span-12 lg:col-span-4 grid gap-1">
    ...
    <!-- table area -->
    <div class="col-span-12 lg:col-span-8 grid gap-1 full-height-overflow">
