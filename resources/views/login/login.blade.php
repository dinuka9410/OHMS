    ...
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    <img alt="" class="-intro-x w-1/2 -mt-16" src="{{ asset('dist/images/hotels-managment.png') }}">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Online <br>Hotel Reservation Administrator</div>
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-8">
                        <form id="login-form">
                            <input type="text" id="input-email" class="intro-x login__input input input--lg border border-gray-300 block" placeholder="username" >
                    ...
                    <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                        <div style="display: none;" class="flex items-center mr-auto">
...
@section('script')
    <script>
        ...
        $(document).ready(function(){
            ...
            sessionStorage.removeItem('currencies_list');
        ...
        cash(function () {
            async function login() {
                ...
                axios.post(`login`, {
                    ...
                    if (err.response.data.message != 'user status inactive' && err.response.data.message != 'Wrong email or password.') {
