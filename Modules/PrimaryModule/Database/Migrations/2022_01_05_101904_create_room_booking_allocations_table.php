...
class CreateRoomBookingAllocationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('room_booking_allocations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('room_booking_allocations');
    }
}
